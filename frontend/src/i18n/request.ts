...
export default getRequestConfig(async ({ requestLocale }) => {
  ...
  return {
    ...
    messages: {
      ...
      "blog.index": (await import(`../../messages/${locale}/blog/index.json`)).default,
      "blog.why-startups-should-choose-custom-software": (await import(`../../messages/${locale}/blog/why-startups-should-choose-custom-software.json`)).default,
      "blog.practical-ai-customer-support-automation": (await import(`../../messages/${locale}/blog/practical-ai-customer-support-automation.json`)).default,
      "blog.cost-of-technical-debt-enterprise": (await import(`../../messages/${locale}/blog/cost-of-technical-debt-enterprise.json`)).default,
