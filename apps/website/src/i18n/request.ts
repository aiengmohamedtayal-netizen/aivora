...
export default getRequestConfig(async ({ requestLocale }) => {
  ...
  return {
    ...
    messages: {
      ...
      "service-details": {
        "ai-solutions": (await import(`../../messages/${locale}/services/ai-solutions.json`)).default,
        "custom-software": (await import(`../../messages/${locale}/services/custom-software.json`)).default,
        "saas-development": (await import(`../../messages/${locale}/services/saas-development.json`)).default,
        "web-development": (await import(`../../messages/${locale}/services/web-development.json`)).default,
        automation: (await import(`../../messages/${locale}/services/automation.json`)).default,
        "startup-mvp": (await import(`../../messages/${locale}/services/startup-mvp.json`)).default,
      },
      blog: {
        ...(await import(`../../messages/${locale}/blog.json`)).default,
        index: (await import(`../../messages/${locale}/blog/index.json`)).default,
        "why-startups-should-choose-custom-software": (await import(`../../messages/${locale}/blog/why-startups-should-choose-custom-software.json`)).default,
        "practical-ai-customer-support-automation": (await import(`../../messages/${locale}/blog/practical-ai-customer-support-automation.json`)).default,
        "cost-of-technical-debt-enterprise": (await import(`../../messages/${locale}/blog/cost-of-technical-debt-enterprise.json`)).default,
      },
